...
type CoordinationStore interface {
	...
	RequestOperationalIntentPublicationIfCurrent(ctx context.Context, publication domain.OperationalIntentPublication, expectedIntentVersion int, expectedIntentRevision int64, expectedStatus domain.IntentStatus) error
...
type Store interface {
	...
	CreateMissionForPlannedFlight(ctx context.Context, mission domain.Mission) (domain.Mission, error)
